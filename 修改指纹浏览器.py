        ...
        headers = {  
            ...
            'name': name,  # 窗口名称
                    ...
                    "browserFingerPrint": {
                        ...
                        'version': '111',  # 浏览器版本，建议92以上，不填则会从92以上版本随机
                        'userAgent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5563.65 Safari/537.36',  # ua，不填则自动生成
...
if __name__ == "__main__":
    ...
    for i in range(num):
        # bit_create(id_list[i],str(start+i),proxy_list[i])
        bit_create(id_list[i],str(start+i),"")
